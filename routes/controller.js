...
exports.getAssignaturesFilter = function (req, res){
    Assignatura.find({  $query: {nom: req.body.value}, $orderby: { nom : 1, quantityest:-1 } },
        function(err, assignatura) {
...
exports.getAssignaturesFilter2 = function (req, res){
    Assignatura.find({  $query: {when: req.body.value}, $orderby: { nom : 1, quantityest:-1 } },
        function(err, assignatura) {
...
exports.getsinfilterAssignature = function (req, res){
    Assignatura.find({  $query: {}, $orderby: { nom : 1, quantityest:-1 } },
        function(err, assignatura) {
        ...
        function(err, estudiant) {
            if (err) {
                ...
                Assignatura.update( {_id : req.params.assignatura_id},
                    {$push: {estudiants : estudiant._id} , $inc: { quantityest: 1 }},
                    function(err, assignatura) {
                        if (err)
                            res.send(err);
